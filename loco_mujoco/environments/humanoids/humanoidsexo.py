...
class HumanoidMuscleExo(BaseHumanoid):
    ...
    **Class**: :class:`loco_mujoco.utils.reward.TargetVelocityReward`
    ...
    def __init__(self, **kwargs):
        ...
        super(HumanoidMuscleExo, self).__init__(use_muscles=True, use_exo=True, **kwargs)

    @staticmethod
    def generate(task="walk", dataset_type="real", **kwargs):

        check_validity_task_mode_dataset(HumanoidMuscleExo.__name__, task, None, dataset_type,
                                         *HumanoidMuscleExo.valid_task_confs.get_all())
        ...
        return BaseHumanoid.generate(HumanoidMuscleExo, path, task, dataset_type, **kwargs)